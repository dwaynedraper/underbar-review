(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    _.each(array, function(element) {
      var iteratedValue = iterator(element);
      if (cache[iteratedValue] === undefined) {
        cache[iteratedValue] = element;
      }
    });
  ...
  _.shuffle = function(array) {
    ...
    for (var index = 0; index < sliced.length; index++) {
      var randomIndex = Math.floor(Math.random() * sliced.length);
      var temp = sliced[index];
      sliced[index] = sliced[randomIndex];
      sliced[randomIndex] = temp;
    }
    return sliced;
  };
  ...
  _.invoke = function(collection, functionOrKey, args) {
    return _.map(collection, function(value) {
      var func = typeof functionOrKey === 'function' ? functionOrKey : value[functionOrKey];
